...
export class ShrinkingHeaderComponent {
  ...
  ngAfterViewInit() {
    ...
    this.renderer.setStyle(this.headersArea, 'backgroundImage', background);
    this.renderer.setStyle(this.headersArea, 'backgroundPosition', 'center');
    this.renderer.setStyle(this.headersArea, 'backgroundSize', 'cover');
