...
export class Login implements OnInit {
    ...
    constructor(public navCtrl: NavController, public api: ApiServices, private formBuilder: FormBuilder, private _toast: ToastServices, private auth: AuthServices) {
